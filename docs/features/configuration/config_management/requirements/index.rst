...
.. feat_req:: Term definition of Parameter
   :id: feat_req__configmgmt__term_parameter
   ...
   Individual vehicle configuration properties used for vehicle specific adaptations are called ``Parameters``.

.. feat_req:: Term definition of Parameter Set
   :id: feat_req__configmgmt__term_parameter_set
   :reqtype: Non-Functional
   :security: NO
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Central housekeeping for Parameters
   :id: feat_req__configmgmt__central_housekeeping
   :reqtype: Functional
   :security: NO
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter relation to a Set
   :id: feat_req__configmgmt__parameter_set_relation
   :reqtype: Functional
   :security: NO
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter name uniqueness
   :id: feat_req__configmgmt__parameter_name_uniqueness
   :reqtype: Functional
   :security: NO
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter name uniqueness
   :id: feat_req__configmgmt__parameter_set_name_uniqueness
   :reqtype: Functional
   :security: NO
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter Set configuration contents
   :id: feat_req__configmgmt__parameter_set_config_contents
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
   ...
   Parameter Set configuration shall contain a mapping of Parameters to Parameter Sets, Parameter names, types and default values.

.. feat_req:: Parameter Set configuration source
   :id: feat_req__configmgmt__parameter_set_config_source
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter modification
   :id: feat_req__configmgmt__parameter_modification
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Config provider interface
   :id: feat_req__configmgmt__provider_interface
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter Set access
   :id: feat_req__configmgmt__parameter_set_access
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__functional_req__file_based
...
.. feat_req:: Parameter Set qualifier
   :id: feat_req__configmgmt__parameter_set_qualifier
   :reqtype: Functional
   :security: YES
   :safety: ASIL_B
...
.. feat_req:: Parameter initial qualifier
   :id: feat_req__configmgmt__parameter_initial_qualifier
   :reqtype: Functional
   :security: YES
   :safety: ASIL_B
   :satisfies: stkh_req__functional_req__safe_config
